...
def load_data():
    ...
    train_images_76 = np.array([scipy.misc.imresize(img,(28,28)) for img in train_images])
    y_train = train_df['is_iceberg'].values.reshape(-1,1)
    state=2017
    X_train, X_test, y_train, y_test,train_index,test_index = train_test_split(train_images_76[:,:,:,0].reshape(-1,28,28,1),
